...
correo = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/setting_vip1?igsh=cHJmeTM1OGs1cjZo' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/setting_vip1?igsh=cHJmeTM1OGs1cjZo' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/setting_vip1?igsh=cHJmeTM1OGs1cjZo' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'labubu' : official[1][0] == String(contact[0]) ? 'labubu' : official[2][0] == String(contact[0]) ? 'labubu' : official[3][0] == String(contact[0]) ? 'labubu' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'labubu' : official[1][0] == String(contact[0]) ? 'labubu' : official[2][0] == String(contact[0]) ? 'labubu' : official[3][0] == String(contact[0]) ? 'labubu' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/setting_vip1?igsh=cHJmeTM1OGs1cjZo' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.instagram.com/setting_vip1?igsh=cHJmeTM1OGs1cjZo' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝙎𝙞𝙨𝙠𝙚𝙙-𝘽𝙤𝙩', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
